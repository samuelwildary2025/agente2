...
4. **set_tool** - Marcação de pedidos ativos (Redis)
5. **confirme_tool** - Verificação de pedidos ativos (Redis)
6. **time_tool** - Consulta de data/hora atual
7. **ean_tool** - Base de conhecimento (RAG com Supabase + Cohere)
...
Marca um pedido como ativo no Redis.

**Exemplo de uso pelo agente:**
```python
set_tool("5511999998888", "ativo", 600)
```
