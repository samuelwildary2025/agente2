#!/usr/bin/env python3
"""
Testar o novo agente LangGraph
"""
...
def testar_agente_langgraph():
    """Testa o agente LangGraph com diferentes cenários"""
    
    print("🧪 Testando agente LangGraph...")
    print("=" * 60)
